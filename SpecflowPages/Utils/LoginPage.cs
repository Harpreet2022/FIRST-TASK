  ...
  public class LoginPage
    {
        public static void LoginStep()
        {
            ...
            //Enter Url
            Driver.driver.FindElement(By.XPath("//a[contains(text(),'Sign In')]")).Click();

            //Enter Username
            Driver.driver.FindElement(By.XPath("//input[@placeholder='Email address']")).SendKeys("harpreetkaur8786@gmail.com");

            //Enter password
            Driver.driver.FindElement(By.XPath("//input[@placeholder='Password']")).SendKeys("Armaan2216");
            Thread.Sleep(1000);
